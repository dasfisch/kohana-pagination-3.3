<div class="pagination">
	...
	<?php else: ?>
		<li class="disabled"><a href="<?php echo HTML::chars($page->url($previous_page)) ?>" rel="prev"><?php echo __('Previous') ?></a></li>
	<?php endif ?>
	...
	<?php else: ?>
		<li class="disabled"><a href="<?php echo HTML::chars($page->url($next_page)) ?>" rel="next"><?php echo __('Next') ?></a></li>
	<?php endif ?>
